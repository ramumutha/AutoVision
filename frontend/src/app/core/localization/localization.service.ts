...
const ENGLISH = {
  ...
  serviceProfitWorkQueue: 'Service Profit Work Queue', serviceProfitWorkQueueContext: 'Read-only operational follow-up queue',
  opportunityWorkCard: 'Opportunity Work Card', opportunityStatus: 'Opportunity status', evidenceClass: 'Evidence class', evidenceEventsUnavailable: 'Detailed evidence events are not available through the current read contract.', followUp: 'Follow-up', history: 'History', followUpDetailUnavailable: 'Follow-up detail is not available through the current opportunity read contract.', followUpHistoryUnavailable: 'Follow-up history is not available through the current read contract.', noFollowUp: 'No follow-up has been created for this opportunity.', noFollowUpHistory: 'No operational history recorded yet.', loadingFollowUp: 'Loading follow-up details', loadingFollowUpHistory: 'Loading follow-up history', unableToLoadFollowUp: 'Unable to load follow-up details', unableToLoadFollowUpHistory: 'Unable to load follow-up history', autoVisionServiceProfit: 'AutoVision Service Profit', humanActor: 'Operational user', previousValue: 'Previous', newValue: 'New',
  mine: 'Mine', me: 'Me', unassigned: 'Unassigned', dueState: 'Due state', ownership: 'Ownership', disposition: 'Disposition', handlingStatus: 'Handling status',
  overdue: 'Overdue', upcoming: 'Due / upcoming', noDueDate: 'No due date', followUpRequired: 'Follow-up required', interestRecorded: 'Interest recorded', declinedRecorded: 'Declined recorded', noResponseRecorded: 'No response recorded', noFurtherAction: 'No further action',
  dueDate: 'Due', owner: 'Owner', assigned: 'Assigned', viewDetails: 'View details', loadMore: 'Load more', noWorkQueueItems: 'No follow-ups match these filters', noWorkQueueItemsContext: 'Try another ownership or filter selection.', loadingWorkQueue: 'Loading Service Profit work queue', updatingWorkQueue: 'Refreshing Service Profit work queue', unableToLoadWorkQueue: 'Unable to load Service Profit work queue', loadedPageOnly: 'Groups and sort order describe the currently loaded page.',
  ...
  businessNavigation: 'Opportunity business views', opportunities: 'Opportunities', loadingOpportunities: 'Updating opportunities',
  ...
  groupBy: 'Group by', noGrouping: 'None', opportunityGroupIncomplete: 'Some opportunities could not be displayed',
  opportunityGroupIncompleteContext: 'The group total is current, but the complete opportunity list is temporarily unavailable. Refresh to try again.',
  ...
  dataCapabilityLoading: 'Checking data capability',
  dataCapabilityUnavailable: 'Data capability unavailable',
  ...
  grossProfitData: 'Gross profit data',
  available: 'Available',
  partial: 'Partial',
