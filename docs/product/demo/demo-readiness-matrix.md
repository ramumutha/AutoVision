...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Opportunity foundation/detection | Yes | Platform domain/detection/demo suites | Ten synthetic scenarios | Via manager | Yes | Evidence-backed revenue opportunity story | Step 2–3 | Synthetic behavior only | GREEN |
| Secure opportunity API | Yes | Access/controller/query tests | Demo tenant and opportunities | Consumed by UI | Keycloak/UserRef flow | Tenant-safe access | Step 1–2 | Local demo identity setup required | GREEN |
