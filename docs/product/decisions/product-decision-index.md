...
Product Decision Records (PDRs) capture approved product choices and their implications. They do not replace architecture decisions or feature/release approval.

| ID | Decision | Status | Date | Related features |
| --- | --- | --- | --- | --- |
| [PDR-001](PDR-001-service-profit-r1-revenue-first.md) | Service Profit R1 uses a revenue-first manager release strategy | Accepted | Not recorded | SP-F001..SP-F015 |
| [PDR-002](PDR-002-mobile-progressive-disclosure.md) | Mobile uses progressive disclosure | Accepted | Not recorded | SP-F012, SP-F013 |
| [PDR-003](PDR-003-opportunity-type-navigation.md) | Opportunity Type is primary Service Profit navigation | Accepted | Not recorded | SP-F010 |
