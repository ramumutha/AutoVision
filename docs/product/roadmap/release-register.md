...
| --- | --- | --- | --- | --- | --- | --- |
| R1-SP | Service Profit opportunity foundation through responsive authenticated manager experience and dealer-data capability disclosure | IMPLEMENTED | Current frozen baseline `48a5c16`; historical feature commits remain in repository history | SP-F001..SP-F015; SP-F004 capability API/UI evidence; grouped manager UX; [manager UX](../service-profit-manager-ux.md) | Angular final A4.5.2 suite 206/206; focused post-edit 31/31; Chromium responsive/accessibility/smoke 15 passed with 1 obsolete filter-history test skipped; production build and diff hygiene pass | Synthetic demo is not production evidence; provider-specific readiness and external KPI validation remain absent; gross-profit attribution remains partial where cost data is incomplete; search is deferred and primary advanced filters are intentionally not exposed |
...
| G6-UNASSIGNED | Controlled dealer-data intake foundation and subsequent gated slices | PLANNED / RESEARCH REQUIRED | G6.1 contract/architecture only; no runtime baseline | SP-F020; [ADR-007](../../architecture/decisions/ADR-007-controlled-dealer-data-intake-boundary.md); [RS-006](../research/RS-006-first-partner-data-intake-questions.md) | G6.1 documentation boundary and governance review; G6.2-G6.6 not implemented | Data capability and gross-profit attribution remain AMBER; DMS/provider readiness, partner evidence, production ROI, recovered revenue, complete gross profit, and consent remain unproven |
