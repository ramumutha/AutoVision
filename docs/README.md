...
- [Commercial contact foundation](architecture/commercial-contact-foundation.md): R1 unified Contact Us model, purpose routing, verification, and deferred demo-access boundary.
